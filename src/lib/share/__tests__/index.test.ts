...
describe('share module exports', () => {
  describe('move-encoder exports', () => {
    ...
    it('should export positionToWthor function', () => {
      expect(typeof positionToWthor).toBe('function');
    });

    it('should export wthorToPosition function', () => {
      expect(typeof wthorToPosition).toBe('function');
    });
