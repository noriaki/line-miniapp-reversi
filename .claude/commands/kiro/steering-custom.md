...
- .specify/settings/templates/steering-custom/*.md
...
Available templates in `.specify/settings/templates/steering-custom/`:
...
- `.specify/settings/` content should NOT be documented (it's metadata, not project knowledge)
