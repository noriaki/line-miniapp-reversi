...
- Verify `.specify/specs/$1/spec.json` exists
...
- .specify/steering/*.md
- .specify/settings/rules/ears-format.md
- .specify/settings/templates/specs/requirements.md
...
- Review generated requirements at `.specify/specs/$1/requirements.md`
