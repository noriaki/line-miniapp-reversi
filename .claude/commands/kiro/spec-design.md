...
- Verify `.specify/specs/$1/requirements.md` exists
...
- .specify/steering/*.md
- .specify/settings/rules/design-*.md
- .specify/settings/templates/specs/design.md
- .specify/settings/templates/specs/research.md
...
- Review generated design at `.specify/specs/$1/design.md`
