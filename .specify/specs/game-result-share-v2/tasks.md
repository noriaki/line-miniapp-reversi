...
- [ ] 2. 手順履歴エンコーダーの実装
- [ ] 2.1 (P) WTHOR 形式での手順エンコード/デコード機能を実装
...
- [ ] 6. ゲーム終了時の自動遷移機能を実装
- [ ] 6.1 ナビゲーションフォールバックコンポーネントを実装
  - 自動遷移開始から 2 秒経過後に「結果を確認する」ボタンを表示
  - ボタンタップで結果ページへ手動遷移
  - 自動遷移成功時は表示されない
  - _Requirements: 1.1, 1.4_

- [ ] 6.2 GameBoard に自動遷移ロジックを追加
